...
const dataFileRead = JSON.parse(fs.readFileSync("./data/data_2019.json")); // an array
const dateFileRead = JSON.parse(fs.readFileSync("./data/dates_2019.json")); // as array

function convertDataItems(dataFileRead, dateFileRead) {
